...
echo "<button class='btn btn-primary' style='margin-left:5px;' id='step1_submit_$index' type='button' onclick='answerHint($index,$qid,1);'>Submit</button>";
echo "</form>";
...
echo "<button class='btn btn-primary' style='margin-left:5px;' id='step2_submit_$index' type='button' onclick='answerHint($index,$qid,2);'>Submit</button>";
echo "</form>";
...
echo "<button class='btn btn-primary' style='margin-left:5px;' id='step3_submit_$index' type='button' onclick='answerHint($index,$qid,3);'>Submit</button>";
echo "</form>";
...
echo "<button class='btn btn-primary' style='margin-left:5px;' id='step4_submit_$index' type='button' onclick='answerHint($index,$qid,4);'>Submit</button>";
echo "</form>";
echo "<br>";
